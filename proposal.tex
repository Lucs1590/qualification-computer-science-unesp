...
\begin{table}[H]
    ...
    \begin{tabular}{l|l|l}
        ...
        Part-Aware Panoptic Segmentation                                & Daan de Geus, Panagiotis Meletis, Chenyang Lu, Xiaoxiao Wen, Gijs Dubbelman                                           &  \cite{DeGeus2021}      \\
        Improving Panoptic Segmentation at All Scales                   & Lorenzo Porzi, Samuel Rota Bulo, Peter Kontschieder                                                                   &  \cite{Porzi2021}       \\
        SpatialFlow: Bridging All Tasks for Panoptic Segmentation       & Qiang Chen, Anda Cheng, Xiangyu He, Peisong Wang, Jian Cheng                                                          &  \cite{Chen2019a}       \\
        Visual relation of interest detection based on part detection   & You Zhou, Fan Yu                                                                                                      &  \cite{YouZhou2021}     \\
        Panoptic Image Annotation with a Collaborative Assistant        & Jasper R.R. Uijlings, Mykhaylo Andriluka, Vittorio Ferrari                                                            &  \cite{Jasper2020}      \\
        Panoptic Segmentation-Based Attention for Image Captioning      & Wenjie Cai, Zheng Xiong, Xianfang Sun, Paul L. Rosin, Longcun Jin, Xinyi Peng                                         &  \cite{Cai2020}         \\
        Supplementary Material: Part-aware Panoptic Segmentation        & Daan de Geus, Panagiotis Meletis, Chenyang Lu, Xiaoxiao Wen, Gijs Dubbelman                                           &  \cite{DeGeus2021a}     \\
        Panoptic Segmentation: A Review                                 & Omar Elharrouss, Somaya Al-Maadeed, Nandhini Subramanian, Najmath Ottakath, Noor Almaadeed, Yassine Himeur            &  \cite{Elharrouss2021}  \\
        PartImageNet: A Large, High-Quality Dataset of Parts            & Ju He, Shuo Yang, Shaokang Yang, Adam Kortylewski, Xiaoding Yuan, Jie-Neng Chen, Shuai Liu, Cheng Yang, Alan Yuille   &  \cite{He2021}   
    \end{tabular}}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|l|l}
        \textbf{Título}                                                                                                                 &  \textbf{Autores}                                                                                                                                                                                                     &  \textbf{Referência}  \\ \hline
        A study on tooth segmentation and numbering using end-to-end deep neural networks                                               & Bernardo Silva, Laís Pinheiro, Luciano Oliveira, Matheus Pithon                                                                                                                                                       &  \cite{Silva2020}       \\
        Accurate Segmentation of Dental Panoramic Radiographs with U-NETS                                                               & Thorbjørn Louring Koch, Mathias Perslev, Christian Igel, Sami Sebastian Brandt                                                                                                                                        &  \cite{Koch2019}        \\
        ToothNet: Automatic Tooth Instance Segmentation and Identification From Cone Beam CT Images                                     & Zhiming Cui, Changjian Li, Wenping Wang                                                                                                                                                                               &  \cite{Cui2019}         \\
        Toothpix: Pixel-Level Tooth Segmentation in Panoramic X-Ray Images based on Generative Adversarial Networks                     & Weiwei Cui, Liaoyuan Zeng, Bunsan Chong, Qianni Zhang                                                                                                                                                                 &  \cite{Cui2021}         \\
